...
const threeOfKind = new SumDistro({ count: 3, description: "Sum all dice if there at least 3 are the same" });
const fourOfKind = new SumDistro({ count: 4, description: "Sum all dice if there at least 4 are the same"  });

// full house scores as flat 25
const fullHouse = new FullHouse({score: 25, description: "25 points if a matching pair and 3 are the same" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: "30 points if any 4 sequential numbers" });
const largeStraight = new LargeStraight({ score: 40, description: "30 points if any 5 sequential numbers" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50 , description: "50 points if all the same number"});
